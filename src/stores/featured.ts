...
import {
    ...
    IconBrandSpotify,
    IconBrandSupabase,
    IconBrandTypescript, IconBrandYoutube, IconCoffee, IconDatabase
...
export const projects = writable({
    crucible: {
        ...
        description: 'Crucible is a no-code solution that lets users build AUnit tests for the software modelling language Alloy. Crucible was published at ISSRE \'23.',
        madeWith: [
